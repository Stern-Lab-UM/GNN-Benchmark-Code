function specs = GNNBenchmark_vertex_model_publication_manifest(mode)
% GNNBenchmark_vertex_model_publication_manifest  Implement GNN Benchmark vertex model publication manifest for this MATLAB workflow.
% Inputs: mode
% Outputs: specs
%GNNBenchmark_VERTEX_MODEL_PUBLICATION_MANIFEST  Publication vertex-model datasets.
%
%   SPECS = GNNBenchmark_VERTEX_MODEL_PUBLICATION_MANIFEST(MODE) returns the dataset
%   definitions used by GNNBenchmark_GENERATE_VERTEX_MODEL_DATASETS.  The manifest is
