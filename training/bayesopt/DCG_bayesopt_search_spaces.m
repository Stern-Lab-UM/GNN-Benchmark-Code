...
%   revision optimization setup: MPNN depth was fixed at 16 layers, and PPGN
%   architecture size was fixed while optimizer/scheduler knobs were swept.
%
%   Example:
...
ppgn.hp_ranges.learning_rate = [1e-4, 1e-2];
ppgn.hp_ranges.batch_size = {'1', '2', '4'};
ppgn.hp_ranges.gradient_clipping = {'0.001', '0.01', '0.1', '1'};
ppgn.hp_ranges.factor = {'0.75'};
