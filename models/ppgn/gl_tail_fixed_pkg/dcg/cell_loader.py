"""Utilities for models / ppgn / gl_tail_fixed_pkg / dcg / cell_loader.py in the DCG benchmark codebase."""
...
class CellLoader():
    """
    Coordinate cell loader responsibilities for the DCG PPGN workflow.
    ...
    def apply_config(self, config):
        """
        Implement the apply config step for models / ppgn / gl_tail_fixed_pkg / dcg / cell_loader.py.
    ...
    def apply_input_instance_norm(self, graphs):
        ...
        def _should_norm(name):
            """
            Implement the should norm step for models / ppgn / gl_tail_fixed_pkg / dcg / cell_loader.py.
    ...
    def train(self):
        """
        Implement the train step for models / ppgn / gl_tail_fixed_pkg / dcg / cell_loader.py.
    ...
    def val(self):
        """
        Implement the val step for models / ppgn / gl_tail_fixed_pkg / dcg / cell_loader.py.
...
class CellsData(Dataset):
    """
    Provide the cells data component used by models / ppgn / gl_tail_fixed_pkg / dcg / cell_loader.py.
...
class StreamingStats():
    ...
    def update(self, values: np.array):
        """
        Implement the update step for models / ppgn / gl_tail_fixed_pkg / dcg / cell_loader.py.
    ...
    def mean(self):
        """
        Implement the mean step for models / ppgn / gl_tail_fixed_pkg / dcg / cell_loader.py.
    ...
    def std(self):
        """
        Implement the std step for models / ppgn / gl_tail_fixed_pkg / dcg / cell_loader.py.
