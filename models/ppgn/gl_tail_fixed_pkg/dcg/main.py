"""Utilities for models / ppgn / gl_tail_fixed_pkg / dcg / main.py in the DCG benchmark codebase."""
...
from dcg.notebook_renderer import Renderer
from dcg.simulator import Simulator
from dcg.file_reader import NodeMap
...
class NaturalOrderGroup(click.Group):
    """
    Provide the natural order group component used by models / ppgn / gl_tail_fixed_pkg / dcg / main.py.
    ...
    def list_commands(self, ctx):
        """
        Implement the list commands step for models / ppgn / gl_tail_fixed_pkg / dcg / main.py.
...
@click.option('--transfer-from', default=None,
              ...
              help='Trained dcg model to initialize inner layers')
