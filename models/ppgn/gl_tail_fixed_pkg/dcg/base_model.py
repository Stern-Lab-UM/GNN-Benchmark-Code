"""Utilities for models / ppgn / gl_tail_fixed_pkg / dcg / base_model.py in the DCG benchmark codebase."""
...
class BaseModel(nn.Module):
    ...
    def output_mask(self, x):
        """
        Implement the output mask step for models / ppgn / gl_tail_fixed_pkg / dcg / base_model.py.
    ...
    def input_mask(self, x):
        """
        Implement the input mask step for models / ppgn / gl_tail_fixed_pkg / dcg / base_model.py.
    ...
    def _find_in_targets(self, args, targets):
        """
        Implement the find in targets step for models / ppgn / gl_tail_fixed_pkg / dcg / base_model.py.
    ...
    def initialize_from(self, other):
        """
        Implement the initialize from step for models / ppgn / gl_tail_fixed_pkg / dcg / base_model.py.
