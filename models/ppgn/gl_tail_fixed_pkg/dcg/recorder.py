"""Utilities for models / ppgn / gl_tail_fixed_pkg / dcg / recorder.py in the DCG benchmark codebase."""
...
class Recorder():
    ...
    def load_model_state(self, config: Configuration):
        ...
        with self.get_out_file(self.model_file, zipped=True, mode='r') as file:
            ...
            # the same dcg pipeline, so this is trusted.
...
class SavedModel():
    """
    Provide the saved model component used by models / ppgn / gl_tail_fixed_pkg / dcg / recorder.py.
