"""Utilities for models / ppgn / gl_tail_fixed_pkg / gnn_benchmark_ppgn / notebook_renderer.py in the GNN Benchmark codebase."""
...
class Renderer():
    """
    Provide the renderer component used by models / ppgn / gl_tail_fixed_pkg / gnn_benchmark_ppgn / notebook_renderer.py.
