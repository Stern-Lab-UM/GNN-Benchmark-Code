"""Utilities for models / ppgn / gl_tail_fixed_pkg / gnn_benchmark_ppgn / recorder.py in the GNN Benchmark codebase."""
...
class SavedModel():
    """
    Provide the saved model component used by models / ppgn / gl_tail_fixed_pkg / gnn_benchmark_ppgn / recorder.py.
