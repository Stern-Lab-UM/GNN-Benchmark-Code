"""Utilities for models / ppgn / gl_tail_fixed_pkg / gnn_benchmark_ppgn / file_reader.py in the GNN Benchmark codebase."""
...
class FileReader():
    ...
    def _parse_binary(self, data):
        """
        Implement the parse binary step for models / ppgn / gl_tail_fixed_pkg / gnn_benchmark_ppgn / file_reader.py.
...
class NamedTokens():
    ...
    def inds(self):
        """
        Implement the inds step for models / ppgn / gl_tail_fixed_pkg / gnn_benchmark_ppgn / file_reader.py.
    ...
    def names(self):
        """
        Implement the names step for models / ppgn / gl_tail_fixed_pkg / gnn_benchmark_ppgn / file_reader.py.
    ...
    def toks(self):
        """
        Implement the toks step for models / ppgn / gl_tail_fixed_pkg / gnn_benchmark_ppgn / file_reader.py.
...
class NodeMap(dict):
    """
    Provide the node map component used by models / ppgn / gl_tail_fixed_pkg / gnn_benchmark_ppgn / file_reader.py.
