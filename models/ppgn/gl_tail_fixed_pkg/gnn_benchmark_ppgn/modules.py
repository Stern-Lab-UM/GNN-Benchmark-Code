"""Utilities for models / ppgn / gl_tail_fixed_pkg / gnn_benchmark_ppgn / modules.py in the GNN Benchmark codebase."""
...
class RegularBlock(nn.Module):
    ...
    def compatible_size(self, other):
        """
        Implement the compatible size step for models / ppgn / gl_tail_fixed_pkg / gnn_benchmark_ppgn / modules.py.
