"""Utilities for models / ppgn / gl_tail_fixed_pkg / gnn_benchmark_ppgn / configuration.py in the GNN Benchmark codebase."""
...
def parse_args(*parsers):
    ...
    def parse(string):
        """
        Implement the parse step for models / ppgn / gl_tail_fixed_pkg / gnn_benchmark_ppgn / configuration.py.
...
def list_or(other):
    """
    Implement the list or step for models / ppgn / gl_tail_fixed_pkg / gnn_benchmark_ppgn / configuration.py.
    ...
    def parser(string):
        """
        Implement the parser step for models / ppgn / gl_tail_fixed_pkg / gnn_benchmark_ppgn / configuration.py.
...
class Configuration():
    ...
    def gpu(self):
        """
        Implement the gpu step for models / ppgn / gl_tail_fixed_pkg / gnn_benchmark_ppgn / configuration.py.
    ...
    def epochs(self):
        """
        Implement the epochs step for models / ppgn / gl_tail_fixed_pkg / gnn_benchmark_ppgn / configuration.py.
    ...
    def target_features(self):
        """
        Implement the target features step for models / ppgn / gl_tail_fixed_pkg / gnn_benchmark_ppgn / configuration.py.
