"""Utilities for models / ppgn / train_gnn_benchmark / gnn_benchmark_ppgn / notebook_renderer.py in the GNN Benchmark codebase."""
...
class Renderer():
    """
    Provide the renderer component used by models / ppgn / train_gnn_benchmark / gnn_benchmark_ppgn / notebook_renderer.py.
