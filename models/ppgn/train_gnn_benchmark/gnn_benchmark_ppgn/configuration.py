"""Utilities for models / ppgn / train_gnn_benchmark / gnn_benchmark_ppgn / configuration.py in the GNN Benchmark codebase."""
...
def list_or(other):
    """
    Implement the list or step for models / ppgn / train_gnn_benchmark / gnn_benchmark_ppgn / configuration.py.
    ...
    def parser(string):
        """
        Implement the parser step for models / ppgn / train_gnn_benchmark / gnn_benchmark_ppgn / configuration.py.
...
class Configuration():
    ...
    def gpu(self):
        """
        Implement the gpu step for models / ppgn / train_gnn_benchmark / gnn_benchmark_ppgn / configuration.py.
    ...
    def epochs(self):
        """
        Implement the epochs step for models / ppgn / train_gnn_benchmark / gnn_benchmark_ppgn / configuration.py.
    ...
    def target_features(self):
        """
        Implement the target features step for models / ppgn / train_gnn_benchmark / gnn_benchmark_ppgn / configuration.py.
