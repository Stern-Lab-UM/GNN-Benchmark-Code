"""Utilities for models / ppgn / predict_dcg / dcg / modules.py in the DCG benchmark codebase."""
...
class RegularBlock(nn.Module):
    ...
    def compatible_size(self, other):
        """
        Implement the compatible size step for models / ppgn / predict_dcg / dcg / modules.py.
