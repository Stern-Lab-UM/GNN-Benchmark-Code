"""Utilities for models / ppgn / predict_dcg / dcg / notebook_renderer.py in the DCG benchmark codebase."""
...
class Renderer():
    """
    Provide the renderer component used by models / ppgn / predict_dcg / dcg / notebook_renderer.py.
