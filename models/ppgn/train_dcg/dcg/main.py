"""Utilities for models / ppgn / train_dcg / dcg / main.py in the DCG benchmark codebase."""
...
class NaturalOrderGroup(click.Group):
    """
    Provide the natural order group component used by models / ppgn / train_dcg / dcg / main.py.
    ...
    def list_commands(self, ctx):
        """
        Implement the list commands step for models / ppgn / train_dcg / dcg / main.py.
