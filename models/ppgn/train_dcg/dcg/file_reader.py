"""Utilities for models / ppgn / train_dcg / dcg / file_reader.py in the DCG benchmark codebase."""
...
class FileReader():
    ...
    def _read_cells_txt(self, file):
        """
        Implement the read cells txt step for models / ppgn / train_dcg / dcg / file_reader.py.
    ...
    def _read_cells_mat(self, file):
        """
        Implement the read cells mat step for models / ppgn / train_dcg / dcg / file_reader.py.
    ...
    def _read_cells_npz(self, file):
        """
        Implement the read cells npz step for models / ppgn / train_dcg / dcg / file_reader.py.
    ...
    def _parse_binary(self, data):
        """
        Implement the parse binary step for models / ppgn / train_dcg / dcg / file_reader.py.
...
class NamedTokens():
    ...
    def inds(self):
        """
        Implement the inds step for models / ppgn / train_dcg / dcg / file_reader.py.
    ...
    def names(self):
        """
        Implement the names step for models / ppgn / train_dcg / dcg / file_reader.py.
    ...
    def toks(self):
        """
        Implement the toks step for models / ppgn / train_dcg / dcg / file_reader.py.
...
class NodeMap(dict):
    """
    Provide the node map component used by models / ppgn / train_dcg / dcg / file_reader.py.
