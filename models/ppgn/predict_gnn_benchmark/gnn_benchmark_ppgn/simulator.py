"""Utilities for models / ppgn / predict_gnn_benchmark / gnn_benchmark_ppgn / simulator.py in the GNN Benchmark codebase."""
...
class Simulator:
    """
    Coordinate simulator responsibilities for the gnn_benchmark_ppgn PPGN workflow.
