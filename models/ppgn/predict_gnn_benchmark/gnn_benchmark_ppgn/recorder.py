"""Utilities for models / ppgn / predict_gnn_benchmark / gnn_benchmark_ppgn / recorder.py in the GNN Benchmark codebase."""
...
class SavedModel():
    """
    Provide the saved model component used by models / ppgn / predict_gnn_benchmark / gnn_benchmark_ppgn / recorder.py.
