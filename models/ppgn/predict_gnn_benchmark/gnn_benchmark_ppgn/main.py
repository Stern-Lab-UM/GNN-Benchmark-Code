"""Utilities for models / ppgn / predict_gnn_benchmark / gnn_benchmark_ppgn / main.py in the GNN Benchmark codebase."""
...
class NaturalOrderGroup(click.Group):
    """
    Provide the natural order group component used by models / ppgn / predict_gnn_benchmark / gnn_benchmark_ppgn / main.py.
    ...
    def list_commands(self, ctx):
        """
        Implement the list commands step for models / ppgn / predict_gnn_benchmark / gnn_benchmark_ppgn / main.py.
