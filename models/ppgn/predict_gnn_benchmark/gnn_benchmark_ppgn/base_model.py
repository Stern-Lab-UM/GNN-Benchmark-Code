"""Utilities for models / ppgn / predict_gnn_benchmark / gnn_benchmark_ppgn / base_model.py in the GNN Benchmark codebase."""
...
#        x[~adj] = 0.  # Remove values outside of the original adjacency
    ...
    def output_mask(self, x):
        """
        Implement the output mask step for models / ppgn / predict_gnn_benchmark / gnn_benchmark_ppgn / base_model.py.
    ...
    def input_mask(self, x):
        """
        Implement the input mask step for models / ppgn / predict_gnn_benchmark / gnn_benchmark_ppgn / base_model.py.
    ...
    def _find_in_targets(self, args, targets):
        """
        Implement the find in targets step for models / ppgn / predict_gnn_benchmark / gnn_benchmark_ppgn / base_model.py.
    ...
    def initialize_from(self, other):
        """
        Implement the initialize from step for models / ppgn / predict_gnn_benchmark / gnn_benchmark_ppgn / base_model.py.
