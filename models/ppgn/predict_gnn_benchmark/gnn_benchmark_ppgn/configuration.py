"""Utilities for models / ppgn / predict_gnn_benchmark / gnn_benchmark_ppgn / configuration.py in the GNN Benchmark codebase."""

import yaml
import copy
import torch

from gnn_benchmark_ppgn.cell_loader import CellLoader
from gnn_benchmark_ppgn.base_model import BaseModel
from gnn_benchmark_ppgn.trainer import Trainer
...
def parse_args(*parsers):
    ...
    def parse(string):
        """
        Implement the parse step for models / ppgn / predict_gnn_benchmark / gnn_benchmark_ppgn / configuration.py.
...
def list_or(other):
    """
    Implement the list or step for models / ppgn / predict_gnn_benchmark / gnn_benchmark_ppgn / configuration.py.
    ...
    def parser(string):
        """
        Implement the parser step for models / ppgn / predict_gnn_benchmark / gnn_benchmark_ppgn / configuration.py.
...
class Configuration():
    """
    Coordinate configuration responsibilities for the gnn_benchmark_ppgn PPGN workflow.
    ...
    def gpu(self):
        """
        Implement the gpu step for models / ppgn / predict_gnn_benchmark / gnn_benchmark_ppgn / configuration.py.
    ...
    def epochs(self):
        """
        Implement the epochs step for models / ppgn / predict_gnn_benchmark / gnn_benchmark_ppgn / configuration.py.
    ...
    def target_features(self):
        """
        Implement the target features step for models / ppgn / predict_gnn_benchmark / gnn_benchmark_ppgn / configuration.py.
