"""Utilities for models / ppgn / predict_gnn_benchmark / gnn_benchmark_ppgn / cell_loader.py in the GNN Benchmark codebase."""
...
class CellLoader():
    ...
    def apply_config(self, config):
        """
        Implement the apply config step for models / ppgn / predict_gnn_benchmark / gnn_benchmark_ppgn / cell_loader.py.
    ...
    def train(self):
        """
        Implement the train step for models / ppgn / predict_gnn_benchmark / gnn_benchmark_ppgn / cell_loader.py.
    ...
    def val(self):
        """
        Implement the val step for models / ppgn / predict_gnn_benchmark / gnn_benchmark_ppgn / cell_loader.py.
...
class CellsData(Dataset):
    """
    Provide the cells data component used by models / ppgn / predict_gnn_benchmark / gnn_benchmark_ppgn / cell_loader.py.
...
class StreamingStats():
    ...
    def update(self, values: np.array):
        """
        Implement the update step for models / ppgn / predict_gnn_benchmark / gnn_benchmark_ppgn / cell_loader.py.
    ...
    def mean(self):
        """
        Implement the mean step for models / ppgn / predict_gnn_benchmark / gnn_benchmark_ppgn / cell_loader.py.
    ...
    def std(self):
        """
        Implement the std step for models / ppgn / predict_gnn_benchmark / gnn_benchmark_ppgn / cell_loader.py.
