"""Utilities for models / ppgn / predict_gnn_benchmark / gnn_benchmark_ppgn / trainer.py in the GNN Benchmark codebase."""
...
class RMSLELoss(nn.Module):
    """
    Provide the rmsleloss component used by models / ppgn / predict_gnn_benchmark / gnn_benchmark_ppgn / trainer.py.
