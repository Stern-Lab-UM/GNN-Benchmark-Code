...
% FILE HEADER
% -------------------------------------------------------------------------
%   File    : DCG_verify_Flip_two_figures.m
%   Project : DCG / GNN-benchmark analysis pipeline.
...
%
% USAGE
%   report = DCG_verify_Flip_two_figures()
%   report = DCG_verify_Flip_two_figures(figures_output_dir)
%
% INPUT
...
if nargin < 1 || isempty(figures_output_dir)
    ...
    if isempty(path_cfg.data_root)
        error('DCG:missingDataRoot', ['Pass figures_output_dir explicitly or set ', ...
