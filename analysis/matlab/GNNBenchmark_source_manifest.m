function m = GNNBenchmark_source_manifest(data_root)
% GNNBenchmark_source_manifest  Implement GNN Benchmark source manifest for this MATLAB workflow.
% Inputs: data_root
% Outputs: m
%GNNBenchmark_SOURCE_MANIFEST  Deterministic fingerprint of a prediction-file set.
%
% PURPOSE
